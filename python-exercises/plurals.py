...
def pluralize(sg):
    ...
    elif sg == 'information' or sg == 'news':
        return ['']
    ...
    elif sg.endswith('mnus') or sg.endswith('llus') or sg.endswith('ocus') or sg.endswith('leus') or sg.endswith('inus') or sg.endswith('abus') or sg.endswith('ulus') or sg.endswith('ius'):
        return [sg[:-2] + 'i']
    ...
    # Regular plurals
    elif sg.endswith('ch') or sg.endswith('x') or sg.endswith('s') or sg.endswith('z'):
        return [sg + 'es']
